...
namespace BankCustomerSystem.Services.Core.Service.Services.Clients
{
    public class FinanceClientService : IFinanceClientService
    {
        private readonly HttpClient _httpClient;
        private readonly IRequestInfoService _requestInfoService;
        public FinanceClientService(HttpClient httpClient, IRequestInfoService requestInfoService)
        {
